...
<body class="h-screen font-sans antialiased leading-none gradient">
                          ...
                          <li class="mr-3">
                            <a class="inline-block px-4 py-2 text-black no-underline hover:text-gray-800 hover:text-underline" href="#">link</a>
                                ...
                                @if (!session()->has('voter_id'))
                                    ...
                                    @endif
                                @else
                                    <span class="p-1 mr-4 bg-gray-200 rounded-full focus:outline-none focus:ring">
                                        <p>{{ session('voter_id') }}</p>
                                    </span>
                                    ...
                                    <a href="{{ route('logout') }}" class="no-underline hover:underline"
                                        onclick="event.preventDefault();
                                            ...
                                            class="px-8 py-4 mx-auto mt-4 font-bold text-gray-800 transition duration-300 ease-in-out transform bg-white rounded-full shadow opacity-75 lg:mx-0 hover:underline lg:mt-0 focus:outline-none focus:shadow-outline hover:scale-105">{{ __('Logout') }}</button></a>
