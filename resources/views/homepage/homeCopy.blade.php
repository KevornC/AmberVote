        ...
        <div class="container flex flex-col flex-wrap items-center px-3 mx-auto md:flex-row">
            ...
            <div class="flex flex-col items-start justify-center w-full text-center md:w-2/5 md:text-left">
                ...
                <a href="{{ route('register') }}"><button
                        class="px-8 py-4 mx-auto my-6 font-bold text-gray-800 transition duration-300 ease-in-out transform bg-white rounded-full shadow-lg hover:bg- lg:mx-0 hover:underline focus:outline-none focus:shadow-outline hover:scale-105">
                        Join Us
                    </button>
                </a>
            </div>
                ...
                <div class="flex-1 overflow-hidden bg-white rounded-t rounded-b-none shadow">
                    <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                        ...
                        <p class="px-6 mb-5 text-base text-gray-800">
                            We have put thousands of hours to ensure that this system has the secuity and functionality
                            to host your election with descretion and fairness.
                        </p>
                    </a>
                </div>
            ...
            <div class="flex flex-col flex-grow flex-shrink w-full p-6 md:w-1/3">
                <div class="flex-1 overflow-hidden bg-white rounded-t rounded-b-none shadow">
                    <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                        ...
                        <p class="px-6 mb-5 text-base text-gray-800">
                            We are in the business of doing good that will change society for the good. This
                            appplication is built to facilate fairness between the different societies and oragnization
                            with the election of a leader.
                        </p>
                    </a>
                </div>
                <div class="flex-none p-6 mt-auto overflow-hidden bg-white rounded-t-none rounded-b shadow">
            ...
            <div class="flex flex-col flex-grow flex-shrink w-full p-6 md:w-1/3">
                <div class="flex-1 overflow-hidden bg-white rounded-t rounded-b-none shadow">
                    <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                        ...
                        <p class="px-6 mb-5 text-base text-gray-800">
                            We build this system with the necessary qualities that will be easy to use. You can add,
                            update and delete data in this application.
                        </p>
                    </a>
                </div>
                <div class="flex-none p-6 mt-auto overflow-hidden bg-white rounded-t-none rounded-b shadow">
